...
the source of truth. The working implementation is [`site/`](../site/) at the repo root; open
`site/index.html` in a browser and it runs.
...
| `../site/` | the working site this package specifies |
| `../site/assets/app.js` | `waterlineSVG()` plus the page controllers |
